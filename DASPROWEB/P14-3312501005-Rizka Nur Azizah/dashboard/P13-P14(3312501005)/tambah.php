...
$cek_nis = "SELECT * FROM calon_mhs WHERE nis = '$nis'";
$result_nis = mysqli_query($koneksi, $cek_nis);

if (mysqli_num_rows($result_nis) > 0) {
    echo "<script>alert('Data dengan NIS sudah ada!'); window.history.back();</script>";
    exit();
}
